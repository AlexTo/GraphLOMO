...
from .methods import AcolBase
from .methods import ADL
from .methods import normalize_tensor
from .methods import spg
...
def inception_v3(architecture, pretrained=False, pretrained_path=None,
                 **kwargs):
    model = {'cam': InceptionCam,
             'acol': InceptionAcol,
             'spg': InceptionSpg,
             'adl': InceptionAdl}[architecture](**kwargs)
    if pretrained:
